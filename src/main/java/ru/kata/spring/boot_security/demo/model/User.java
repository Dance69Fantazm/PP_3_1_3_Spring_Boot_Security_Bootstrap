...
public class User implements UserDetails {
    ...
    public @NotBlank(message = "поле не должно быть пустым!") @Email String getEmail() {
        return email;
    }

    public void setEmail(@NotBlank(message = "поле не должно быть пустым!") @Email String email) {
        this.email = email;
    }
